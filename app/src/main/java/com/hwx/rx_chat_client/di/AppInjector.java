...
public class AppInjector {
    ...
    public static void init(RxChatApplication rxChatApplication) {
        DaggerAppComponent.builder()
                .application(rxChatApplication)
                .utilsModule(new UtilsModule(rxChatApplication))
                .build()
                .inject(rxChatApplication);
